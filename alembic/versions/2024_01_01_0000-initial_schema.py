...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('status', postgresql.ENUM('NEW', 'DOWNLOADED', 'ANALYZED', 'NOTIFIED', 'SOLD', name='tenderstatus', create_type=False), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('status', postgresql.ENUM('pending', 'waiting_for_capture', 'succeeded', 'canceled', 'refunded', name='paymentstatus', create_type=False), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('tender_id', sa.Integer(), nullable=False),
        sa.Column('client_id', sa.Integer(), nullable=False),
        sa.Column('notification_type', postgresql.ENUM('teaser', 'report', name='notificationtype', create_type=False), nullable=False),
        sa.Column('status', postgresql.ENUM('pending', 'sent', 'failed', 'bounced', name='notificationstatus', create_type=False), nullable=False),
